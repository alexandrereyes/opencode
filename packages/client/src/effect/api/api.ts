...
import type { Snippet } from "@opencode/schema/snippet"
...
export type ServerNativeAppsListOutput = NativeApp.Availability
export type ServerNativeAppsListOperation<E = never> = () => Effect.Effect<ServerNativeAppsListOutput, E>

export type ServerNativeAppsOpenInput = {
  readonly app: NativeApp.ID
  readonly path: AbsolutePath
  readonly reveal?: boolean | undefined
}
export type ServerNativeAppsOpenOutput = void
export type ServerNativeAppsOpenOperation<E = never> = (
...
export type SnippetListOutput = ReadonlyArray<Snippet.Info>
export type SnippetListOperation<E = never> = () => Effect.Effect<SnippetListOutput, E>

export type SnippetSaveInput = {
  readonly id: Snippet.ID
  readonly name: string
...
export type SnippetSaveOutput = Snippet.Info
export type SnippetSaveOperation<E = never> = (input: SnippetSaveInput) => Effect.Effect<SnippetSaveOutput, E>

export type SnippetRemoveInput = { readonly id: Snippet.ID }
export type SnippetRemoveOutput = void
export type SnippetRemoveOperation<E = never> = (input: SnippetRemoveInput) => Effect.Effect<SnippetRemoveOutput, E>

export interface SnippetApi<E = never> {
  readonly list: SnippetListOperation<E>
  readonly save: SnippetSaveOperation<E>
  readonly remove: SnippetRemoveOperation<E>
}
...
export type SessionLogOutput =
  | (
      ...
      | {
          ...
          readonly created: number
          readonly metadata?: { readonly [x: string]: unknown } | undefined
          readonly type: "session.subagent.input.assigned"
          readonly durable: { readonly aggregateID: string; readonly seq: Event.Seq; readonly version: Event.Version }
          readonly location?: Location.Ref | undefined
          readonly data: {
            readonly sessionID: Session.ID
            ...
            readonly origin: { readonly messageID: SessionMessage.ID; readonly toolCallID: string }
          }
        }
      | {
          readonly id: Event.ID
