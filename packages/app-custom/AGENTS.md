...
- This package owns the custom web product. Use `packages/app-custom`, `@opencode/ui-custom`, and `@opencode/session-ui-custom`; do not put custom web changes in the upstream-owned UI packages.
