...
export const dict = {
  ...
  "context.overview.availablePool": "Available inference pool",
  ...
  "context.overview.noPool": "No active inference accounts",
  "context.overview.unknownWeekly": "Weekly balance unknown",
  "context.overview.noAvailableBalance": "No inference accounts available now",
  ...
  "context.overview.availablePoolCapacity": "Accounts available now: {{ready}}/{{total}}",
  "context.overview.poolPlans": "Rotation · Pro 20x, Pro 5x, and Plus",
