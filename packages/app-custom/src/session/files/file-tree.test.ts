...
beforeAll(async () => {
  ...
  mock.module("@opencode/ui-custom/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@opencode/ui-custom/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@opencode/ui-custom/icon", () => ({ Icon: () => null }))
  mock.module("@opencode/ui-custom/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
