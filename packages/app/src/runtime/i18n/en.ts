...
export const dict = {
  ...
  "context.overview.pool": "Pro pool",
  "context.overview.availablePool": "Available Pro pool",
  "context.overview.banked": "Banked resets · Pro",
  ...
  "context.overview.noPool": "No active Pro accounts",
  "context.overview.unknownWeekly": "Weekly balance unknown",
  "context.overview.noAvailableBalance": "No Pro accounts available now",
  ...
  "context.overview.availablePoolCapacity": "Pro accounts available now: {{ready}}/{{total}}",
  "context.overview.measurements": "Current measurements: {{measured}}/{{total}}",
  "context.overview.updated": "Updated {{time}}",
  "context.overview.outsidePool": "Outside the active Pro pool",
