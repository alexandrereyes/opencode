...
export const filesystem = makeGlobalNode({ service: FileSystem.FileSystem, layer, deps: [] })
export const path = makeGlobalNode({
  service: Path.Path,
  layer: process.platform === "win32" ? layerWin32 : layerPosix,
  deps: [],
})
